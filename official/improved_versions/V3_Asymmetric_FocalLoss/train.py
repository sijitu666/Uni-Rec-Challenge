...
def parse_args() -> argparse.Namespace:
    ...
    # Loss function.
    parser.add_argument('--loss_type', type=str, default='bce', choices=['bce', 'focal', 'asymmetric'],
                        help='Loss type: bce = BCEWithLogits, focal = Focal Loss, asymmetric = Asymmetric Focal')
