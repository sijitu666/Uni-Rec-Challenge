...
from utils import sigmoid_focal_loss, asymmetric_focal_loss, EarlyStopping
...
class PCVRHyFormerRankingTrainer:
    ...
    def __init__(
        ...
        self.asym_pos_alpha: float = 0.25
        self.asym_neg_alpha: float = 0.75
        self.asym_pos_gamma: float = 2.0
        self.asym_neg_gamma: float = 4.0
    ...
    def _train_step(self, batch: Dict[str, Any]) -> float:
        ...
        if self.loss_type == 'focal':
            ...
            loss = asymmetric_focal_loss(logits, label,
                                         pos_alpha=self.asym_pos_alpha,
                                         neg_alpha=self.asym_neg_alpha,
                                         pos_gamma=self.asym_pos_gamma,
                                         neg_gamma=self.asym_neg_gamma)
        else:
