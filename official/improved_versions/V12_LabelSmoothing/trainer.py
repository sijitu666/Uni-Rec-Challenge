...
from utils import sigmoid_focal_loss, smooth_labels, EarlyStopping
...
class PCVRHyFormerRankingTrainer:
    ...
    def _train_step(self, batch: Dict[str, Any]) -> float:
        ...
        smooth_label = smooth_labels(label, self.label_smoothing)

        if self.loss_type == 'focal':
            loss = sigmoid_focal_loss(logits, smooth_label, alpha=self.focal_alpha, gamma=self.focal_gamma)
        else:
