...
This repository uses **git worktree** to manage multiple branches simultaneously in separate directories. This allows you to work on different branches in parallel with independent AI coding sessions.
...
Open separate IDE windows for each worktree:
...
Each window runs an independent AI session, allowing you to:
